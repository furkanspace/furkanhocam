...
import {
    ...
    User, Shield, LogOut, Menu, X, ChevronRight, Zap, Database, Crown, TreePine, Swords
} from 'lucide-react';
...
const Sidebar = ({ currentPage, onNavigate }) => {
    ...
    const navItems = [
        ...
        { id: 'DAILY_TOURNAMENT', label: 'Turnuva', icon: <Swords size={22} />, sub: 'Günlük Yarışma', always: true },
